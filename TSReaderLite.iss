[Setup]
AppName=TSReader Lite
AppVersion=2.8.46b
AppVerName=TSReader Lite 2.8.46b
AppPublisher=COOL.STF
Uninstallable=1
DefaultDirName={pf}\COOL.STF\TSReaderLite
OutputBaseFilename=TSReaderLite2.8.46b
OutputDir=.
DefaultGroupName=TSReaderLite
AppPublisherURL=http://www.coolstf.com/
AppUpdatesURL=http://www.coolstf.com/okdownload.html#tsreader
AppSupportURL=http://www.coolstf.com/tsreader/support.html
AppCopyright=Copyright © 2003-2008 COOLSTF.com, Inc.
LicenseFile=license-lite.txt

[Files]
;Main part
Source: C:\Development\TSReader\TSReaderLite.exe; DestDir: {app}; Flags: ignoreversion
...
Source: C:\Development\TSReader\TSReader.exe.manifest; DestDir: {app}; Flags: ignoreversion
...
[Icons]
Name: {group}\TSReaderLite; Filename: {app}\TSReaderLite.exe; Parameters: ; WorkingDir: {app}; IconFilename: ; IconIndex: 0; Flags: createonlyiffileexists
...
[Run]
Filename: {app}\TSReaderLite.exe; Description: Launch application; Flags: postinstall nowait skipifsilent
