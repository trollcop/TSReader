...
/* begin correctness testing */
  ...
  set_control_words(test_invalid_key,test_1_key);
...
#define noONE_POISONED_PACKET
  ...
  // start decryption
  set_control_words(s_key_e,s_key_o);
