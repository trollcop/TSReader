/**
* \file $Id: bsp_tuner.h,v 1.10 2005/10/18 16:38:17 paulja Exp $
*
...
typedef char*           TUNERSubMode_t;    /* description of supported submode        */
...
typedef struct {
   ...
   char           *name;         /* Tuner brand & type name, e.g. for use in listboxes    */
...
typedef DRXStatus_t (*TUNEROpenFunc_t)  (pTUNERInstance_t tuner, DtDevice *device);
...
DRXStatus_t DRXBSP_TUNER_Open ( pTUNERInstance_t tuner, DtDevice *device  );
