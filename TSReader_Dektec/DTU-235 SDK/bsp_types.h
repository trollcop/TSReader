/**
* \file $Id: bsp_types.h,v 1.4 2005/07/20 10:08:51 paulja Exp $
*
...
*/
typedef enum {
  DRX_STS_READY = 3,         /**< indicating that device/service is ready */
  DRX_STS_BUSY = 2,          /**< indicating that device/service is busy */
  DRX_STS_OK = 1,            /**< indicating that everything is OK */
  DRX_STS_INVALID_ARG = -1,  /**< indicating invalid arguments */
  DRX_STS_ERROR = -2,         /**< indicating general error */
  DRX_STS_FUNC_NOT_AVAILABLE = -3 /**< indicating unavaiable functionality */
