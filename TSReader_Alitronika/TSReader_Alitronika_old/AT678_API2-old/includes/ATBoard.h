...
protected:
	...
	std::string m_FirmwareFname;	///< Fully qualified name for the firmeware file.
	s32			m_nRefCount;		///< Reference count of the instance
	...
	bool		m_bFpgaFailed;		///< Indication that some FPGA function(s) failed. Further FPGA access is disabled.
