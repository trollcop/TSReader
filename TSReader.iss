...
AppName=TSReader
AppVersion=2.8.46b
AppVerName=TSReader 2.8.46b
AppPublisher=COOL.STF
Uninstallable=1
DefaultDirName={pf}\COOL.STF\TSReader
OutputBaseFilename=TSReader2.8.46b
OutputDir=.
DefaultGroupName=TSReader
Password=c76h8
AppPublisherURL=http://www.coolstf.com/
AppUpdatesURL=http://www.coolstf.com/tsreader/clients
...
[Files]
;Main part
Source: C:\Development\TSReader\TSReader.exe; DestDir: {app}; Flags: ignoreversion noencryption nocompression
...
[Icons]
Name: {group}\TSReader; Filename: {app}\TSReader.exe; Parameters: ; WorkingDir: {app}; IconFilename: ; IconIndex: 0; Flags: createonlyiffileexists
...
Filename: {app}\TSReader.exe; Description: Launch application; Flags: postinstall nowait skipifsilent
