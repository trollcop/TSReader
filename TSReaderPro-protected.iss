...
AppVersion=2.7.45f
AppVerName=TSReader Pro 2.7.45f
AppPublisher=COOL.STF
Uninstallable=1
DefaultDirName={pf}\COOL.STF\TSReaderPro
OutputBaseFilename=TSReaderPro2.7.45f-protected
OutputDir=.
DefaultGroupName=TSReader Pro
Password=x98f5g
AppPublisherURL=http://www.coolstf.com/
AppUpdatesURL=http://www.coolstf.com/tsreader/pro-clients
AppSupportURL=http://www.coolstf.com/tsreader/support.html
AppCopyright=Copyright © 2003-2007 COOLSTF.com, Inc.
LicenseFile=license.txt
Encryption=Yes

[Files]
;Main part
Source: C:\Development\TSReader\TSReaderPro-protected.exe; DestDir: {app}; Flags: ignoreversion noencryption nocompression
...
;HASP HL Driver Setup
Source: C:\Program Files\Aladdin\HASP HL\Redistribute\drivers\Setup\HASPUserSetup.exe; DestDir: {app}; Flags: ignoreversion
...
Filename: {app}\TSReaderPro-protected.exe; Parameters: "-L "; Description: Launch application; Flags: postinstall nowait skipifsilent
Filename: {app}\HASPUserSetup.exe;
