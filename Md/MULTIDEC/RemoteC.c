...
BOOL Load_Key_Section(LPSTR SectionName)
{
 ...
 for ( i=0; i < 128; i++ ) {
                      RemoteKey[i].TimeOutRate = 0;
                      RemoteKey[i].RepeatRate = 0;
                      RemoteKey[i].SwitchPos = 0;
                      RemoteKey[i].SendKey[0][0]=0x00;
                      RemoteKey[i].SendKey[1][0]=0x00;
                      RemoteKey[i].SendKey[2][0]=0x00;
                      RemoteKey[i].SendKey[3][0]=0x00;
                      RemoteKey[i].SendKey[4][0]=0x00;
 };
