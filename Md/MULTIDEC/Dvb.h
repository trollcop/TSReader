...
#define MAXFILTER 32
struct TFilter Filter[MAXFILTER];
...
int Current_Eit_Index_Size=0x10000;

struct TEIT_Index EIT[EIT_INDEX_SIZE];
...
static unsigned char DayTable1[12] = {31, 28, 31, 30, 31, 30, 31, 31, 30,31, 30, 31};
static unsigned char DayTable2[12] = {31, 29, 31, 30, 31, 30, 31, 31, 30,31, 30, 31};
static char WeekDays[14]="SoMoDiMiDoFrSa";
