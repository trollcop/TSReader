	...
	Slot=New_Dialog_Slot(hDlg);
        ...
        case WM_TIMER:
			   ...
			   Slot=Get_Dialog_Slot(hDlg);
				if ( Slot < 0 ) {
				          MessageBox(hDlg,"Fehler :Unbekannter Videotext-Dialoge","MULTI-Decoder",MB_ICONSTOP|MB_OK);
						  EndDialog(hDlg,0);
						  return(TRUE);
			};
    ...
    LONG lParam)
{
	...
	switch (message) {
        case WM_INITDIALOG:
    		...
    		SendMessage (GetDlgItem(hDlg,IDC_COMBO1), CB_INSERTSTRING, 0, (LPARAM)(LPSTR)"Automatisch");
    		SendMessage (GetDlgItem(hDlg,IDC_COMBO1), CB_INSERTSTRING, 1, (LPARAM)(LPSTR)"Englisch");
    		SendMessage (GetDlgItem(hDlg,IDC_COMBO1), CB_INSERTSTRING, 2, (LPARAM)(LPSTR)"Deutsch");
    		SendMessage (GetDlgItem(hDlg,IDC_COMBO1), CB_INSERTSTRING, 3, (LPARAM)(LPSTR)"Italienisch");
    		SendMessage (GetDlgItem(hDlg,IDC_COMBO1), CB_INSERTSTRING, 4, (LPARAM)(LPSTR)"Französisch");
    		SendMessage (GetDlgItem(hDlg,IDC_COMBO1), CB_INSERTSTRING, 5, (LPARAM)(LPSTR)"Spanisch");
