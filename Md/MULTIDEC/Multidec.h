...
extern struct TEIT_Index EIT[EIT_INDEX_SIZE];
...
extern BOOL Has_Sdt;
#define MAXNIT 512
extern struct tNIT NIT[MAXNIT];
#define NEUNIT 96
extern struct tNIT NITNeu[NEUNIT];

#define MAXFILTER 32

extern struct TFilter Filter[MAXFILTER];
...
BOOL ColorMix=FALSE;
unsigned short HCYUV2RGBTabelle[64*64*64];
