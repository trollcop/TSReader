...
//  Version 1.1
//
//  These routines can decompress the dishnetwork EIT title and descriptions that
//  are compressed.  Also it can decompress the EPG 7 day guide title and descriptions 
//  located on pid 768
//
...
// To decode, just start with the first bits of a compressed data byte array
// and compare them with values in the table when a match is found you
// have your first character, now move on to the next sequence of bits until you have
// decoded the entire compressed data byte array.
//
// When using the table, start at the begining and compare for a sequence
// of bits, compare only the number of bits, if the bits sequence don't compare
...
struct _table Table128[MAX_TABLE128] = {
...
struct _table Table255[MAX_TABLE255] = {
...
//
// Dishnetwork EIT decompression for compressed titles and descriptions 
// in the EIT pid 0x12
//
