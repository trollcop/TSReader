...
void (*ptr_set_cws) (unsigned char *cws, csakey *key);
void (*ptr_decrypt) (csakey *key, unsigned char *data);
#ifdef INCLUDE_CSA
...
int (__stdcall *get_keyset_size) (void);
int (__stdcall *get_internal_parallelism) (void);
void (__stdcall *set_control_words) (unsigned char *ev, unsigned char *od, unsigned char *myKeys);
int (__stdcall *decrypt_packets)(unsigned char **cluster, unsigned char *myKeys);
