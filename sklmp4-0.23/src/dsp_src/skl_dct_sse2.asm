...
globl Skl_IDct16_Sparse_SSE2
globl Skl_Dct16_SSE2
...
%macro fLLM_PASS 1  ; %1:Shift

  movdqa xmm0, [ecx+0*16]   ; In0
  movdqa xmm2, [ecx+2*16]   ; In2
  movdqa xmm3, xmm0
  movdqa xmm4, xmm2
  movdqa xmm7, [ecx+7*16]   ; In7
  movdqa xmm5, [ecx+5*16]   ; In5
  ...
  movdqa xmm3, [ecx+3*16]   ; In3
  movdqa xmm4, [ecx+4*16]   ; In4
  movdqa xmm1, xmm3
  psubsw xmm3, xmm4         ; t4 = In3-In4
  paddsw xmm4, xmm1         ; t3 = In3+In4
  movdqa xmm6, [ecx+6*16]   ; In6
  movdqa xmm1, [ecx+1*16]   ; In1
  psubsw xmm1, xmm6         ; t6 = In1-In6
  paddsw xmm6, [ecx+1*16]   ; t1 = In1+In6
  ...
  psllw  xmm2, %1+1         ; shift t5 (shift +1 to..
  psllw  xmm1, %1+1         ; shift t6  ..compensate cos4/2)
  psllw  xmm4, %1           ; shift t3
  psllw  xmm5, %1           ; shift t2
  psllw  xmm7, %1           ; shift t0
  psllw  xmm6, %1           ; shift t1
  psllw  xmm3, %1           ; shift t4
  psllw  xmm0, %1           ; shift t7
  ...
  movdqa [ecx+4*16], xmm4   ; => out4
  paddsw xmm2, xmm1         ; xmm2: t6+t5
  movdqa [ecx+0*16], xmm5   ; => out0
  ...
  movdqa [ecx+2*16], xmm5   ; => out2
  movdqa xmm5, xmm3         ; save t4
  movdqa [ecx+6*16], xmm4   ; => out6
  ...
  movdqa [ecx+1*16], xmm1   ; => out1
  movdqa [ecx+3*16], xmm0   ; => out3
  movdqa [ecx+5*16], xmm7   ; => out5
  movdqa [ecx+7*16], xmm5   ; => out7
...
%macro fMTX_MULT 6   ; [%1/2/3=src/coeffs,rounders][%4/5/6=src/coeffs,rounders][

  movdqa    xmm0, [ecx+%1*16+0]   ; xmm0 = [0123][4567]
  movdqa    xmm2, [ecx+%4*16+0]

  pshufhw   xmm0, xmm0, 00011011b ; xmm0 = [0123][7654]
  pshufhw   xmm2, xmm2, 00011011b ; xmm2 = [0123][7654]

  movdqa    xmm4, xmm0
  shufps    xmm0, xmm2, 01000100b ; xmm0 = [0123][0123']
  shufps    xmm4, xmm2, 11101110b ; xmm4 = [7654][7654']

  movdqa    xmm2, xmm0
  paddsw    xmm0, xmm4     ; xmm0 = [a0 a1 a2 a3][a0 a1 a2 a3']
  psubsw    xmm2, xmm4     ; xmm2 = [b0 b1 b2 b3][b0 b1 b2 b3']

  movdqa    xmm4, xmm0
  punpckldq xmm0, xmm2            ; xmm0 = [a0 a1 b0 b1][a2 a3 b2 b3]  
  punpckhdq xmm4, xmm2
  pshufd    xmm2, xmm0, 01001110b ; xmm2 = [a2 a3 b2 b3][a0 a1 b0 b1]
  pshufd    xmm6, xmm4, 01001110b
  ...
  psraw    xmm4, 4               ; => [-2048, 2047]
  movdqa  [ecx+%4*16+0], xmm4
%endmacro
...
Skl_Dct16_SSE2:
  mov ecx, [esp+4]
  fLLM_PASS  3
  fMTX_MULT  0, fTab1, Fdct_Rnd0, 1, fTab2, Fdct_Rnd2
  fMTX_MULT  2, fTab3, Fdct_Rnd1, 3, fTab4, Fdct_Rnd1
  fMTX_MULT  4, fTab1, Fdct_Rnd0, 5, fTab4, Fdct_Rnd1
  fMTX_MULT  6, fTab3, Fdct_Rnd1, 7, fTab2, Fdct_Rnd1
